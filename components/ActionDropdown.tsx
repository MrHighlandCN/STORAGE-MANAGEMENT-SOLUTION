...
import { deleteFile, renameFile, updateFile } from '@/lib/actions/file.action';
            ...
            <DialogContent className='!shad-dialog button bg-white border-none'>
                ...
                {['rename', 'delete', 'share'].includes(value) && (
                    <DialogFooter className='flex flex-col gap-3 md:flex-row'>
                        ...
                        <Button className='!modal-submit-button' onClick={handlAction}>
                    ...
                    {actionsDropdownItems.map((actionItem) => (
                        <DropdownMenuItem
                            ...
                            onClick={() => {
                                ...
                                if (['rename', 'share', 'delete', 'details']
